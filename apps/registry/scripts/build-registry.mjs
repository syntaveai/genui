...
const REGISTRY = [
  ...
  {
    name: "avatar",
    componentFile: "avatar.tsx",
    dependencies: ["clsx", "tailwind-merge"],
    description: "An image element with a fallback for representing the user.",
  },
  {
    name: "spinner",
    componentFile: "spinner.tsx",
    dependencies: ["clsx", "tailwind-merge"],
  ...
  {
    name: "kbd",
    componentFile: "kbd.tsx",
    dependencies: ["clsx", "tailwind-merge"],
    description: "Used to display textual user input from keyboard.",
  },
  {
    name: "aspect-ratio",
    componentFile: "aspect-ratio.tsx",
    dependencies: [],
    description: "Displays content within a desired ratio.",
  },
  {
    name: "button-group",
    componentFile: "button-group.tsx",
    dependencies: ["clsx", "tailwind-merge"],
    description: "A container that groups related buttons together with consistent styling.",
  },
  {
    name: "toggle-group",
    componentFile: "toggle-group.tsx",
    dependencies: ["clsx", "tailwind-merge"],
    description: "A set of two-state buttons that can be toggled on or off.",
  },
  {
    name: "input-group",
    componentFile: "input-group.tsx",
    dependencies: ["clsx", "tailwind-merge"],
    description: "Add addons, buttons, and helper content to inputs.",
  },
  {
    name: "field",
    componentFile: "field.tsx",
    dependencies: ["clsx", "tailwind-merge"],
    description: "Combine labels, controls, and help text to compose accessible form fields.",
  },
  {
    name: "alert-dialog",
    componentFile: "alert-dialog.tsx",
    dependencies: ["clsx", "tailwind-merge"],
    description: "A modal dialog that interrupts the user with important content and expects a response.",
  },
  {
    name: "combobox",
    componentFile: "combobox.tsx",
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    description: "Autocomplete input with a list of suggestions.",
  },
  {
    name: "context-menu",
    componentFile: "context-menu.tsx",
    dependencies: ["clsx", "tailwind-merge"],
    description: "Displays a menu of actions triggered by a right click.",
  },
  {
    name: "hover-card",
    componentFile: "hover-card.tsx",
    dependencies: ["clsx", "tailwind-merge"],
    description: "For sighted users to preview content available behind a link.",
  },
  {
    name: "menubar",
    componentFile: "menubar.tsx",
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    description: "A visually persistent menu common in desktop applications.",
  },
  {
    name: "navigation-menu",
    componentFile: "navigation-menu.tsx",
    dependencies: ["clsx", "tailwind-merge"],
    description: "A collection of links for navigating websites.",
  },
  {
    name: "input-otp",
    componentFile: "input-otp.tsx",
    dependencies: ["clsx", "tailwind-merge"],
    description: "Accessible one-time password component with copy-paste functionality.",
  },
  {
    name: "command",
    componentFile: "command.tsx",
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    description: "Command menu for search and quick actions.",
  },
  {
    name: "carousel",
    componentFile: "carousel.tsx",
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    description: "A carousel with motion and swipe built using Embla.",
  },
  {
    name: "resizable",
    componentFile: "resizable.tsx",
    dependencies: ["clsx", "tailwind-merge"],
    description: "Accessible resizable panel groups and layouts with keyboard support.",
  },
  {
    name: "sidebar",
    componentFile: "sidebar.tsx",
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    description: "A composable, themeable and customizable sidebar component.",
  },
  {
    name: "calendar",
    componentFile: "calendar.tsx",
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    description: "A calendar component that allows users to select a date.",
  },
  {
    name: "date-picker",
    componentFile: "date-picker.tsx",
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
